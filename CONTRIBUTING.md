...
issue](https://github.com/cisagov/ansible-role-clamav/issues) in
...
request](https://github.com/cisagov/ansible-role-clamav/pulls), you
...
pyenv virtualenv <python_version_to_use> ansible-role-clamav
pyenv local ansible-role-clamav
